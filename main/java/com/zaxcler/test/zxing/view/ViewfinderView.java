...
package com.zaxcler.test.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  private Drawable line;//扫描线
  private Rect mRect;//扫描边线
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    line=resources.getDrawable(R.mipmap.zx_code_line);
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      if ((position+=5)<frame.bottom-frame.top){
        mRect.set(frame.left+5,frame.top+position-6,frame.right-5,frame.top+position+6);
        line.setBounds(mRect);
        line.draw(canvas);
        invalidate();
      }else {
        position=0;
