...
/**
 * 婊戝姩鍏抽棴椤甸潰鍩虹被锛屼娇鐢ㄦ椂缁ф壙姝ょ被骞朵娇鐢˙lankTheme涓婚鍗冲彲
 */
public class SwipeActivity extends Activity {
    ...
    /**
     * 鏄惁鍙互鍦ㄩ〉闈换鎰忎綅缃彸婊戝叧闂〉闈紝濡傛灉鏄痜alse鍒欎粠宸﹁竟婊戞墠鍙互鍏抽棴銆�     */
    ...
    class SwipeLayout extends FrameLayout {
        ...
        //private View backgroundLayer;鐢ㄦ潵璁剧疆婊戝姩鏃剁殑鑳屾櫙鑹�       
        ...
        /**
         * 瓒呰繃浜唗ouchslop浠嶇劧娌℃湁杈惧埌娌℃湁鏉′欢锛屽垯蹇界暐浠ュ悗鐨勫姩浣�         */
        ...
        /**
         * 寮瑰洖锛屼笉鍏抽棴锛屽洜涓簂eft鏄�锛屾墍浠etX鍜宻etTranslationX鏁堟灉鏄竴鏍风殑
         *
         * @param withVel 浣跨敤璁＄畻鍑烘潵鐨勬椂闂�         */
